...
A) Pre-requisites
---------------
1. **Install VirtualBox on your local system.** VirtualBox is a virtualisation software, that will be used to create a Windows Instance on your local system. Steps for installing the same are below: -
